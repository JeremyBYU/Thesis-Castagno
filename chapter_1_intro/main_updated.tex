...
% Talk about the type of situations we are interested in handling
% Want to talk about how others approach planning. Sensor based planning, map based planning.  
% Talk about how rooftops have not been considered. How modelling rooftop has not been done very much.
% How looking at usable area is a big deal
% Talk about need a planner that considers both the convention and non-conventional sources. The need to account for risk fo the landing site and the distance?


% What causes emergencies, how is it currently handled, why its insufficient
% Whtas being proposed to find alternative landing sites
