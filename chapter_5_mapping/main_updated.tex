...
%   \end{subfigure}%
  \caption[Comparison of multi-goal planners]{Comparison of multi-goal planning definitions. The green state depicts the initial state, e.g., where the \ac{UAS} begins its emergency landing trajectory.  Unfilled circles are goal states.}
