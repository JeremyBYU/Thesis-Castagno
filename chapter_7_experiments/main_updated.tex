...
\begin{figure}[!htb]
  ...
  \caption[Photo of Environmental Setup]{(\subref{fig:ch7_workspace_a}) Photo of environment setup. (\subref{fig:ch7_workspace_b}) Ground truth measurement of environment}\label{fig:ch7_workspace}
\end{figure}
